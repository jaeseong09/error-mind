...
export default function Sidebar(){
  ...
  return(
    <div className="w-60 h-screen bg-terminal-bg flex-col flex" >
      ...
      <Link href={"/projects"}>
        <div className={`w-full h-12 mt-3 ${pathname=="/projects" ? "bg-primary" :'text-text-tertiary hover:bg-terminal-bar'}`}>
          <div className={`flex ml-1 w-[98%] h-12 p-3 border-none ${pathname=="/projects" ? "bg-bg-sidebar" : "bg-none"}`}>
            <img src={"/briefcase.svg"} alt="briefcase.svg" className="w-5" />
